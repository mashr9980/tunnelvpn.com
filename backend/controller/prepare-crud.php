...
class Prepare_crud
{
    ...
    public function update($tablename, $data, $condition, $conditionValues = array())
{
    $updatecolumn = array();
    ...
    // Add condition values to the types and values arrays
    ...
    public function updatePrepare($tablename, $data, $condition, $conditionValues = array())
    {
        $updatecolumn = array();
        foreach ($data as $key => $value) {
            $updatecolumn[] = "`$key`= ?";
